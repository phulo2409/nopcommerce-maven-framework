...
public class UserCheckOutPUI {
    ...
    public final static String BILLING_ADDRESS_DROPDOWN = "Xpath=//select[@id='billing-address-select']";
    ...
    public final static String BILLING_CITY_TEXT = "Xpath=//div[@class='billing-info']//li[@class='city']";
    ...
    public final static String SHIPPING_CITY_TEXT = "Xpath=//div[@class='shipping-info-wrap']//li[@class='city']";
    ...
    public final static String SELECT_CREDIT_CARD_DROPDOWN = "Xpath=//select[@id='CreditCardType']";
    public final static String CARDHOLDER_NAME_TEXTBOX = "Xpath=//input[@id='CardholderName']";
    public final static String CARD_NUMBER_TEXTBOX = "Xpath=//input[@id='CardNumber']";
    public final static String EXPIRATION_MONTH_DROPDOWN = "Xpath=//select[@id='ExpireMonth']";
    public final static String EXPIRATION_YEAR_DROPDOWN = "Xpath=//select[@id='ExpireYear']";
    public final static String CARD_CODE_TEXTBOX = "Xpath=//input[@id='CardCode']";
